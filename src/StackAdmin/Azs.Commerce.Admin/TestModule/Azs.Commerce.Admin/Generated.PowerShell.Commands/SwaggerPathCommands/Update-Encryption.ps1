...
function Update-Encryption
{
    ...
    if ('UpdateEncryption' -eq $PsCmdlet.ParameterSetName) {
        Write-Verbose -Message 'Performing operation UpdateEncryptionWithHttpMessagesAsync on $CommerceAdminClient.'
        $TaskResult = $CommerceAdminClient.UpdateEncryptionWithHttpMessagesAsync()
    } else {
