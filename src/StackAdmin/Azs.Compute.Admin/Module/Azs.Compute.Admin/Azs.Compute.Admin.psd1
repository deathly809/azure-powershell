...
GUID = 'de50ad6a-ec61-42dd-b9b0-38109ab988a0'
...
FunctionsToExport = 'Get-AzsComputeVMExtension', 'Delete-AzsComputeQuota', 
               'Get-AzsComputeOperation', 'New-AzsComputePlatformImage', 
               'Get-AzsComputePlatformImage', 'New-AzsComputeQuota', 
               'Delete-AzsComputePlatformImage', 'New-AzsComputeVMExtension', 
               'Set-AzsComputeQuota', 'Delete-AzsComputeVMExtension', 
               'Get-AzsComputeQuota', 'New-DataDiskObject', 'New-ImageDetailsObject', 
               'New-OsDiskObject', 'New-VMExtensionObject', 
               'New-PlatformImageObject', 'New-QuotaObject', 'New-AzureBlobObject'
