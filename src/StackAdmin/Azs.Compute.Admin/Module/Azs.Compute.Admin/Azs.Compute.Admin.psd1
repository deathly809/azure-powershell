...
GUID = 'b49d3f7b-980d-4a35-b11a-bddddf62e4db'
...
FunctionsToExport = 'New-PlatformImage', 'Get-PlatformImage', 'Get-Quota', 
               'New-VMExtension', 'Remove-PlatformImage', 'Remove-Quota', 'New-Quota', 
               'Remove-VMExtension', 'Get-VMExtension', 'New-ImageDetailsObject', 
               'New-DataDiskObject', 'New-OsDiskObject', 'New-AzureBlobObject', 
               'New-PlatformImageObject', 'New-VMExtensionObject', 'New-QuotaObject'
