...
function New-AzsPlatformImage
{
    ...
    param(    
        [Parameter(Mandatory = $false, ParameterSetName = 'InputObject_PlatformImages_Create')]
        [Parameter(Mandatory = $false, ParameterSetName = 'ResourceId_PlatformImages_Create')]
