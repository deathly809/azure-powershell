...
$dllFullName = Join-Path -Path $ClrPath -ChildPath 'Microsoft.PowerShell.Azs.Gallery.Admin.v010.dll'
if(-not (Test-Path -Path $dllFullName -PathType Leaf)) {
    . (Join-Path -Path $PSScriptRoot -ChildPath 'AssemblyGenerationHelpers.ps1')
    New-SDKAssembly -AssemblyFileName 'Microsoft.PowerShell.Azs.Gallery.Admin.v010.dll' -IsAzureSDK:$True
}
