...
{
    [OutputType([Microsoft.PowerShell.Azs.Gallery.Admin.v010.Models.GalleryItem])]
    ...
    $NewServiceClient_params = @{
        FullClientTypeName = 'Microsoft.PowerShell.Azs.Gallery.Admin.v010.GalleryAdminClient'
    }
