...
function New-Registration
{
    ...
    param(    
        ...
        [Microsoft.PowerShell.Azs.Gallery.Admin.v010.Models.GalleryItemUriPayload]
        $GalleryItemUri
    )
...
'@ 
    ...
    if ('Registrations_Create' -eq $PsCmdlet.ParameterSetName) {
        ...
        $taskResult = $GalleryAdminClient.Registrations.CreateWithHttpMessagesAsync($GalleryItemUri)
    } else {
