...
@{
    ...
    TypesToProcess    = @('Generated.PowerShell.Commands\FormatFiles\Azs.Storage.Admin.Type.ps1xml')

    # Format files (.ps1xml) to be loaded when importing this module
    FormatsToProcess  = @('Generated.PowerShell.Commands\FormatFiles\Azs.Storage.Admin.Format.ps1xml')
