...
function Get-AzsUpdate {
    ...
    param(    
        ...
        [Parameter(Mandatory = $true, ParameterSetName = 'InputObject_Updates_Get')]
        [Parameter(Mandatory = $true, ParameterSetName = 'Updates_List')]
        [Parameter(Mandatory = $true, ParameterSetName = 'Updates_Get')]
        [Parameter(Mandatory = $true, ParameterSetName = 'ResourceId_Updates_Get')]
        [System.String]
        $Location,
    ...
    Process {
        ...
        if ('InputObject_Updates_Get' -eq $PsCmdlet.ParameterSetName -or 'ResourceId_Updates_Get' -eq $PsCmdlet.ParameterSetName) {
            $GetArmResourceIdParameterValue_params = @{
                IdTemplate = '/subscriptions/{subscriptionId}/resourcegroups/System.{location}/providers/Microsoft.Update.Admin/updateLocations/{updateLocation}/updates/{update}'
            }
        ...
        if ('Updates_List' -eq $PsCmdlet.ParameterSetName) {
            ...
            $TaskResult = $UpdateAdminClient.Updates.ListWithHttpMessagesAsync($Location, $UpdateLocation)
        }
        elseif ('Updates_Get' -eq $PsCmdlet.ParameterSetName -or 'InputObject_Updates_Get' -eq $PsCmdlet.ParameterSetName -or 'ResourceId_Updates_Get' -eq $PsCmdlet.ParameterSetName) {
            ...
            $TaskResult = $UpdateAdminClient.Updates.GetWithHttpMessagesAsync($Location, $UpdateLocation, $Update)
        }
        else {
