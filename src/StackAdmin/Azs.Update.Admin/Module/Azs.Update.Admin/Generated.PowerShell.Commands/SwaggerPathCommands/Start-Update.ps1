...
function Start-Update
{
    ...
    [CmdletBinding(DefaultParameterSetName='Updates_Update')]
    param(    
        [Parameter(Mandatory = $true, ParameterSetName = 'Updates_Update')]
        [System.String]
        $ResourceGroup,
    ...
    $skippedCount = 0
    $returnedCount = 0
    if ('Updates_Update' -eq $PsCmdlet.ParameterSetName) {
        Write-Verbose -Message 'Performing operation UpdateMethodWithHttpMessagesAsync on $UpdateAdminClient.'
        $taskResult = $UpdateAdminClient.Updates.UpdateMethodWithHttpMessagesAsync($ResourceGroup, $UpdateLocation, $Update)
    } else {
