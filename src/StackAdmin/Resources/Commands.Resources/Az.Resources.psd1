#
# Module manifest for module 'PSGet_Az.Resources'
#
...
Description = 'Microsoft Azure PowerShell - Azure Resource Manager cmdlets in PowerShell and PowerShell Core.  Manages subscriptions, tenants, resource groups, deployment templates, providers, and resource permissions in Azure Resource Manager.  Provides cmdlets for managing resources generically across resource providers.'
